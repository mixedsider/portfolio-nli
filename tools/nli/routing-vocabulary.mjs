...
export const summarizeWords = ["요약", "정리", "뭘 했", "뭘 한", "무슨 프로젝트", "간단히", "짧게"];
export const portfolioSummaryWords = ["포트폴리오 전체", "포트폴리오 요약", "포트폴리오를 요약", "포트폴리오 한눈에", "포트폴리오 핵심"];
export const projectSummaryWords = ["요약", "정리", "뭐야", "무슨", "어떤", "설명", "소개", "답변", "간추려"];
export const currentProjectWords = ["지금 보고 있는", "현재 보고 있는", "보고 있는 프로젝트", "이 프로젝트", "현재 프로젝트", "여기", "이 서비스"];
